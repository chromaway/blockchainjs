...
function Blockchain (connector, opts) {
  ...
  self.latest = {hash: util.ZERO_HASH, height: -1}
...
Blockchain.prototype._syncBlockchain = function () {
  return Promise.reject(new errors.NotImplemented('Blockchain._syncBlockchain'))
}

/**
 */
Blockchain.prototype._syncLatest = util.makeConcurrent(function () {
  var self = this
