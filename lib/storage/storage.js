...
function Storage (opts) {
  ...
  Object.defineProperties(self, {
    ...
    compactMode: {enumerable: true, value: opts.compactMode}
  })
...
Storage.prototype.getLastHash = function () {
  return Q.reject(new errors.NotImplemented('Storage.getLastHash'))
}
...
Storage.prototype.setLastHash = function () {
  return Q.reject(new errors.NotImplemented('Storage.setLastHash'))
}
...
Storage.prototype.getChunkHashesCount = function () {
  return Q.reject(new errors.NotImplemented('Storage.getChunkHashesCount'))
}
...
Storage.prototype.getChunkHash = function () {
  return Q.reject(new errors.NotImplemented('Storage.getChunkHashes'))
}
...
Storage.prototype.putChunkHashes = function () {
  return Q.reject(new errors.NotImplemented('Storage.putChunkHashes'))
}
...
Storage.prototype.truncateChunkHashes = function () {
  return Q.reject(new errors.NotImplemented('Storage.truncateChunkHashes'))
}
...
Storage.prototype.getHeadersCount = function () {
  return Q.reject(new errors.NotImplemented('Storage.getHeadersCount'))
}
...
Storage.prototype.getHeader = function () {
  return Q.reject(new errors.NotImplemented('Storage.getHeaders'))
}
...
Storage.prototype.putHeaders = function () {
  return Q.reject(new errors.NotImplemented('Storage.putHeaders'))
}
...
Storage.prototype.truncateHeaders = function () {
  return Q.reject(new errors.NotImplemented('Storage.truncateBlockHashes'))
}
...
Storage.prototype.clear = function () {
  return Q.reject(new errors.NotImplemented('Storage.clear'))
}
