 ...
 * @property {?Object} data `null` for unconfirmed and invalid
 * @property {number} data.blockHeight
 * @property {string} data.blockHash
 * @property {(undefined|number)} index available only in SPV supported networks
 * @property {(undefined|string[])} merkle available only in SPV supported networks
 */
...
Network.prototype.getUnspent = function () {
  return Q.reject(new errors.NotImplemented('Network.getUnspent'))
}
