...
function Connector (opts) {
  ...
  opts = _.extend({networkName: 'livenet'}, opts)
...
/**
 * @typedef {Object} Connector~TxBlockIdObject
 * @property {string} source `blocks` or `mempool`
 * @property {Object} [data] defined only for confirmed transactions
...
/**
 * Return Connector~TxBlockIdObject
 *
 * @abstract
 * @param {string} txid
 * @return {Promise<Connector~TxBlockIdObject>}
 */
Connector.prototype.getTxBlockId = function () {
  return Promise.reject(new errors.NotImplemented('Connector.getTxBlockId'))
}
 ...
 * @param {string} [source] `blocks` or `mempool`
 * @param {(string|number)} [from] `blockid` or `height`
 * @param {(string|number)} [to] `blockid` or `height`
 * @param {string} [status]
 */
