...
/**
 * @typedef {Object} Connector~TxBlockHashObject
 ...
 */
Connector.prototype.getTxBlockHash = function () {
  return Promise.reject(new errors.NotImplemented('Connector.getTxBlockHash'))
}
