...
/**
 * Set._readyState and emit `newReadyState` if state changed
 *
 * @private
...
Connector.prototype.headersQuery = function () {
  return Promise.reject(new errors.NotImplemented('Connector.headersQuery'))
}
