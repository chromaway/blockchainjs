...
ChromaInsight.prototype._request = function (path, data) {
  ...
  if (!self.isConnected()) {
    var err = new errors.Network.NotConnected('ChromaInsight', requestOpts.uri)
 ...
 * @return {boolean}
 */
ChromaInsight.prototype.supportsSPV = function () {
  return true
}
...
ChromaInsight.prototype.getHeader = function (id) {
  return this._request('/header/' + id)
    .catch(errors.Network.NotFound, function () {
      var msg = id
