...
function Chromanode (opts) {
  ...
  self._request = util.makeCuncurrent(
 ...
 * @return {Promise}
 */
Chromanode.prototype.subscribe = util.makeCuncurrent(function (opts) {
  var self = this
  return Promise.try(function () {
    ...
    if (request.event === 'newBlock') {
      self._socket.on('new-block', util.makeCuncurrent(function (hash, height) {
